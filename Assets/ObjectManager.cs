...
public class ObjectManager : MonoBehaviour
{
    ...
    public void DropFrog()
    {
        ...
        if (Distance < 50)
        {
            ...
            Frogb = false; check++;
            //  level3++;check++;
            Fruit7.SetActive(true); clickSound.Play();
        }
        else
        {
    ...
    public void nextbutton1()
    {
        ...
        else if (x == 1)
        {
            ...
            SceneManager.LoadScene("DragAndDropObjectLevel2");
        }
        else if (x == 2)
        {
            ScoreDrag.totalscore += (50 - time);
            SceneManager.LoadScene("DragAndDropObjectLevel3");
        }
        else if (x == 3)
        {
